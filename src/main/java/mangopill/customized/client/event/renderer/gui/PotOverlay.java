package mangopill.customized.client.event.renderer.gui;
...
public class PotOverlay implements LayeredDraw.Layer {
    ...
    public void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        guiGraphics.blit(getCLoc("textures/gui/pot_background.png"), centerX, centerY, elementWidth, elementHeight, 0, 0, elementWidth, elementHeight, elementWidth, elementHeight);
        ...
        guiGraphics.blit(getCLoc("textures/gui/pot_background.png"), centerX, centerY1, elementWidth, elementHeight, 0, 0, elementWidth, elementHeight, elementWidth, elementHeight);
