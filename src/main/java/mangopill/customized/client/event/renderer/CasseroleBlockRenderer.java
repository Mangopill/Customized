...
public class CasseroleBlockRenderer implements BlockEntityRenderer<CasseroleBlockEntity> {
    ...
    @Override
    public void render(@Nonnull CasseroleBlockEntity casseroleBlockEntity, float v, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource multiBufferSource, int light, int overlay) {
