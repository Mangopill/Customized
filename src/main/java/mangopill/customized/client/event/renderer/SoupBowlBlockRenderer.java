...
public class SoupBowlBlockRenderer implements BlockEntityRenderer<SoupBowlBlockEntity> {
    ...
    @Override
    public void render(@Nonnull SoupBowlBlockEntity soupBowlBlockEntity, float v, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource multiBufferSource, int light, int overlay) {
