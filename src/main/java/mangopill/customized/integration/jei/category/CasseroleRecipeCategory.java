...
public class CasseroleRecipeCategory implements IRecipeCategory<CasseroleRecipe> {
    ...
    @Override
    public @Nonnull RecipeType<CasseroleRecipe> getRecipeType() {
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull CasseroleRecipe recipe, @Nonnull IFocusGroup focuses) {
        setPotRecipe(builder, recipe, 18, 6, 6, 4,
                1, 45, 91, 45);
    }

    @Override
    public @Nonnull List<Component> getTooltipStrings(@Nonnull CasseroleRecipe recipe, @Nonnull IRecipeSlotsView recipeSlotsView, double mouseX, double mouseY) {
