...
public final class JeiUtil {
    ...
    public static List<CasseroleRecipe> getCasseroleRecipeList() {
        return Minecraft.getInstance().level.getRecipeManager().getAllRecipesFor(ModRecipeRegistry.CASSEROLE.get()).stream().toList();
    }

    public static List<BrewingBarrelRecipe> getBrewingBarrelRecipeList() {
        return Minecraft.getInstance().level.getRecipeManager().getAllRecipesFor(ModRecipeRegistry.BREWING_BARREL.get()).stream().toList();
    }
    ...
    public static void setPotRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull CasseroleRecipe recipe,
    ...
    public static void addPotTooltip(@Nonnull CasseroleRecipe recipe, double mouseX, double mouseY, List<Component> tooltipString,
    ...
    public static void addJeiInfo(@Nonnull IRecipeRegistration registration, Supplier<Item> item, String s) {
