...
public class PotStrategyHandler {
    ...
    public void registry(@Nonnull String potName, @Nonnull PotInteractionStrategy... strategy) {
    ...
    public InteractionResult useByRegistry(String potName, ItemStack itemStackInHand, BlockState state, Level level, BlockPos pos,
