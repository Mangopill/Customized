...
public class FoodValue {
    ...
    public static final FoodProperties BROAD_BEAN = new FoodProperties.Builder()
            .nutrition(1).saturationMod(0.2F).effect(() -> new MobEffectInstance(MobEffects.POISON, 50, 0), 0.4F).build();
    ...
    public static final FoodProperties SOYBEAN = new FoodProperties.Builder()
            .nutrition(1).saturationMod(0.3F).effect(() -> new MobEffectInstance(MobEffects.POISON, 60, 0), 0.6F).build();
    ...
    public static final FoodProperties TOMATO_AND_BEEF_BRISKET_SOUP = new FoodProperties.Builder()
            .nutrition(18).saturationMod(1.0F).effect(
                    () -> new MobEffectInstance(MobEffects.SATURATION, MEDIUM, 1), 1.0F).effect(
                    () -> new MobEffectInstance(ModEffectRegistry.ROBUST.get(), MEDIUM, 2), 1.0F).effect(
    ...
    public static final FoodProperties FISH_MAW_AND_CHICKEN_SOUP = new FoodProperties.Builder()
            .nutrition(16).saturationMod(1.0F).effect(
                    () -> new MobEffectInstance(MobEffects.SATURATION, MEDIUM, 1), 1.0F).effect(
                    () -> new MobEffectInstance(ModEffectRegistry.VITALITY_RESTORATION.get(), SHORT, 2), 1.0F).effect(
                    () -> new MobEffectInstance(ModEffectRegistry.SUSTAINED_ENERGY.get(), MEDIUM, 2), 1.0F).build();
    public static final FoodProperties BRAISED_CHICKEN_WITH_SHIITAKE_MUSHROOMS_SOUP = new FoodProperties.Builder()
            .nutrition(16).saturationMod(1.0F).effect(
                    ...
                    () -> new MobEffectInstance(ModEffectRegistry.SMOOTH_BLOOD_FLOW.get(), MEDIUM, 2), 1.0F).build();
    public static final FoodProperties RADISH_AND_PORK_RIB_SOUP = new FoodProperties.Builder()
            .nutrition(17).saturationMod(1.0F).effect(
                    () -> new MobEffectInstance(MobEffects.SATURATION, MEDIUM, 1), 1.0F).effect(
                    () -> new MobEffectInstance(ModEffectRegistry.HYDRATION_AND_PLUMPNESS.get(), MEDIUM, 1), 1.0F).effect(
                    () -> new MobEffectInstance(ModEffectRegistry.MENTAL_STIMULATION.get(), MEDIUM, 2), 1.0F).build();
}
