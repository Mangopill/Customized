...
public class ModItemRegistry {
    public static final DeferredRegister<Item> ITEM = DeferredRegister.create(Registries.ITEM, Customized.MODID);
    ...
    public static final Supplier<Item> SPOON = registerWithCreativeTab(
            "spoon", () -> new ShovelItem(Tiers.IRON, 2.0F, -3.0F, new Item.Properties()));
