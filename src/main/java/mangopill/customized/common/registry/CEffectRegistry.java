...
public final class CEffectRegistry {
    ...
    public static final Holder<MobEffect> NOCTENERGY_SURGE = MOB_EFFECT.register("noctenergy_surge", () -> new NoctenergySurgeEffect(0x4B0A88));
