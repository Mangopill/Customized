...
public final class CBlockEntityTypeRegistry {
    ...
    public static final Supplier<BlockEntityType<WokBlockEntity>> WOK = BLOCK_ENTITY_TYPE.register(
            "wok", basicBlockEntityType(WokBlockEntity::new, CBlockRegistry.WOK));
    public static final Supplier<BlockEntityType<SteamerBlockEntity>> STEAMER = BLOCK_ENTITY_TYPE.register(
            "steamer", basicBlockEntityType(SteamerBlockEntity::new, CBlockRegistry.STEAMER));
    ...
    public static final Supplier<BlockEntityType<DishBlockEntity>> DISH = BLOCK_ENTITY_TYPE.register(
            "dish", basicBlockEntityType(DishBlockEntity::new, CBlockRegistry.DISH));
    public static final Supplier<BlockEntityType<PlatterBlockEntity>> PLATTER = BLOCK_ENTITY_TYPE.register(
            "platter", basicBlockEntityType(PlatterBlockEntity::new, CBlockRegistry.PLATTER));
