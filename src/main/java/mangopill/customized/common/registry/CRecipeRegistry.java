...
public final class CRecipeRegistry {
    ...
    public static final Supplier<RecipeType<WokRecipe>> WOK = RECIPE_TYPE.register("wok", () -> registerRecipeType("wok"));
    public static final Supplier<RecipeType<SteamerRecipe>> STEAMER = RECIPE_TYPE.register("steamer", () -> registerRecipeType("steamer"));
