...
public class CBlockRegistry {
    ...
    public static final Supplier<Block> FISH_MAW_AND_CHICKEN_SOUP = BLOCK.register(
            "fish_maw_and_chicken_soup", () -> new HandEatReturnContainerBlock(famousDishBlockProperties(), FoodValue.FISH_MAW_AND_CHICKEN_SOUP, CItemRegistry.FAMOUS_DISH_PLATE, 2));
...
/*    public static final Supplier<Block> ROASTER = BLOCK.register(
    ...
    public static final Supplier<Block> CRATE = BLOCK.register(
            "crate", () -> new CrateBlock(Block.Properties.ofFullCopy(BARREL)));
    public static final Supplier<Block> CUTTING_BOARD = BLOCK.register(
            "cutting_board", () -> new CuttingBoardBlock(Block.Properties.ofFullCopy(BARREL)));
}
