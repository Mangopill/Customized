...
public class CasseroleRecipe extends AbstractPotRecipe {
    public CasseroleRecipe(NonNullList<Ingredient> ingredientItem, NonNullList<Ingredient> seasoningItem, ItemStack spiceItem, ItemStack output, int cookingTime) {
