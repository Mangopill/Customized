...
public class CasseroleRecipe extends AbstractPotRecipe {
    public CasseroleRecipe(NonNullList<Ingredient> ingredientItem, NonNullList<Ingredient> seasoningItem, Ingredient spiceItem, ItemStack output, int cookingTime, ResourceLocation id) {
        super(ingredientItem, seasoningItem, spiceItem, output, cookingTime,
                ...
                PotRecord.CASSEROLE.ingredientCount(), PotRecord.CASSEROLE.seasoningCount(), id);
    }
}
